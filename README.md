# Electronic-Sandwich using a microcontroller and LED matrix, integrating the capacitive touch pins on the microcontroller to create an interactive display on a sandwich
